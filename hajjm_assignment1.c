 ...
 *   First prints a message indicating which segment’s radius is being obtained,
 *   then reads and returns the radius entered by the user
 *
 * Parameters:
 *   n - The index number of the spherical segment.
 *
 * Returns:
 ...
 *   Prints a message asking for the height, then reads and returns
 *   the height entered by the user.
 *
 * Parameters:
 *   None.
 *
 * Returns:
 *   The height ha entered by the user.
 */
float get_ha() {
    float ha;
 ...
 *
 * Returns:
 *   The height hb entered by the user.
 */
float get_hb() {
    float hb;
 ...
 *   Checks that all values are positive, ha and hb do not exceed R,
 *   and that hb is less than ha. Prints "Invalid Input." if any
 *   condition fails.
 *
 * Parameters:
 ...
 *
 * Returns:
 *   1 if the inputs are valid, 0 if the inputs are invalid.
 */
...
/*
 * Calculates the vertical height (h) of the spherical segment
 *   by subtracting hb from ha.
 *
 * Parameters:
 *   ha - The height of the top area of the spherical segment.
 *   hb - The height of the bottom area of the spherical segment.
...
/*
 * Calculates the radius of the top circular area (a) of the spherical segment
 *   using the radius of the sphere (R) and the top height (ha).
 *
 * Parameters:
 *   R  - The radius of the sphere.
 *   ha - The height of the top area of the spherical segment.
 *
 * Returns:
 *   The radius a of the top circular area.
 */
...
/*
 * Calculates the radius of the bottom circular area (b) of the spherical segment
 *   using the radius of the sphere (R) and the bottom height (hb).
 *
 * Parameters:
 *   R  - The radius of the sphere.
 *   hb - The height of the bottom area of the spherical segment.
 *
 * Returns:
 *   The radius b of the bottom circular area.
 */
...
/*
 * Calculates the surface area of the top circular area of the spherical segment
 *   using the formula π * a * a.
 *
 * Parameters:
 *   a - The radius of the top circular area.
 *
 * Returns:
 *   The surface area of the top circle.
 */
...
/*
 * Calculates the surface area of the bottom circular area of the spherical segment
 *   using the formula π * b * b.
 *
 * Parameters:
 *   b - The radius of the bottom circular area.
 *
 * Returns:
 *   The surface area of the bottom circle.
 */
...
/*
 * Calculates the lateral surface area of the spherical segment
...
/*
 * Calculates the total surface area of the spherical segment
 *   by adding the top, bottom, and lateral surface areas.
 *
 * Parameters:
 ...
 *   using the formula: (π / 6) * h * (3a*a + 3b*b + h*h).
 *
 * Parameters:
 *   h - The vertical height of the spherical segment.
 *   a - The radius of the top circular area.
...
/*
 * Prints the calculated results of a spherical segment,
 *   including the total surface area and volume.
 *
 * Parameters:
 *   R  - The radius of the sphere.
 *   ha - The height of the top area of the spherical segment.
